...
<div id="demo-container" 
	...
	<div class="list-group">
	  ...
	  <button type="button" onclick="devSubmit('dev3');" class="list-group-item list-group-item-action">파라미터 핸들링 - Command 객체</button>
	  <button type="button" onclick="devSubmit('insertDev');" class="list-group-item list-group-item-action">파라미터 핸들링 - DB insert</button>
	</div>
</div>
<script>
/**
